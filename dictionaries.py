...
events_mapping_fortuna = {
    ...
    "obie druzyny strzela gola i liczba goli będzie większa niż 3.5":{"name":"btts_and_o35"},
    "spotkanie/obie druzyny strz.gola": {"name": "game/btts"},
    "spotkanie/obie drużyny strzelą gola": {"name": "game/btts"},
    "spotkanie/1.pol. ilosc bramek" :{"name":"game/1st_half_goals"},
    "spotkanie/1.połowa liczba goli":{"name":"game/1st_half_goals"},
    "spotkanie/1.drużyna liczba goli":{"name":"game_1st_team_goals"},
    "spotkanie/2.drużyna liczba goli":{"name":"game_2nd_team_goals"},
    "spotkanie bez remisu": {"name": "dnb"},
    "handicap 0:1": {"name": "eh-1"},
    "handicap 0:2": {"name": "eh-2"},
    "handicap 2:0": {"name": "eh+2"},
    ...
    "1.pol. 1.druzyna dokladna ilość bramek":{"name":"1st_half_1st_team_goals"},
    "1.drużyna 1.połowa liczba goli":{"name":"1st_half_1st_team_goal"},
    "2.drużyna 1.połowa liczba goli":{"name":"1st_half_2nd_team_goal"},
    ...
    "gol w obu połowach" : {"name":"goals_both_halfs"},
    'dokladny wynik': {"name": "cs"},
    "dokładny wynik": {"name": "cs"},
    '1.pol. dokladny wynik': {"name": "1st_half_cs"},
    "1.połowa dokładny wynik": {"name": "1st_half_cs"},
    ...
    "1.drużyna 2.połowa liczba goli": {"name": "1st_team_goals_2nd_half"},
    "2.drużyna 2.połowa liczba goli": {"name": "2nd_team_goals_2nd_half"},
    '2.druzyna strz.gola w 2.pol.': {"name": "2nd_team_to_score_2nd_half"},
    ...
    "2.drużyna 2.połowa dokładna liczba goli":{"name":"2nd_half_2nd_team_goals"},
    "1.drużyna 2.połowa dokładna liczba goli":{"name":"2nd_half_1st_team_goals"},
    "1.pol./spotkanie/liczba goli w spotkaniu":{"name":"half_end_goals"},
    "1.drużyna Multiwynik":{"name":"1st_team_multoscore"},
    "2.drużyna Multiwynik":{"name":"2nd_team_multoscore"},
    "będzie wynik w trakcie spotkania":{"name":"score_during_game"},
    "nie będzie wyniku w trakcie spotkania":{"name":"no_score_during_game"},
}
events_mapping_sts = {
    "mecz": {"name": "game"},
    "spotkanie": {"name": "game"},
    ...
    "liczba fauli": {"name": "fouls_number"},
    "1.drużyna liczba fauli": {"name": "1st_team_fouls_number"},
    "2.drużyna liczba fauli": {"name": "2nd_team_fouls_number"},
    ...
    "liczba zmian":{"name":"subs"},
    "1.połowa-zmiana":{"name":"1st_half_sub"},
    ...
    "Zawodnik rezerwowy strzeli gola (nie wystąpi od początku spotkania)":{"name":"sub_to_score"},
    "Asystuje przy golu, ZK, CK (musi wystąpić od początku meczu)":{"name":"asist_card"},
...
"Rumunia":["Rumunia"],"Armenia":["Armenia"],"San Marino":["San Marino"],"Irlandia Pln.":["Irlandia Pln.","Irlandia Północna","Irlandia Płn."],
...
"Syria":["Syria"],"Katar":["Katar"],"Tajlandia":["Tajlandia"],"Irak":["Irak"],
         "Oman":["Oman"],"Afganistan":['Afganistan'],"Liban":["Liban"],"Kuwejt":["Kuwejt"],
         "Bahrajn":["Bahrajn"],"Z.E.A.":["Z.E.A."],"Jordania":["Jordania"],
...
"Kanada":["Kanada"],"Jamajka":["Jamajka"],"Indie":["Indie"],
...
"Wacker Innsbruck":["FC Wacker Innsbruck","W. Innsbruck"],
...
"St.Truiden": ["St.Truiden","St. Truiden VV","St Truidense","Sint Truidense VV","St. Truiden"],
...
"Santa Clara":["CD Santa Clara","Cd Santa Clara","Santa Clara"],
"Nacional Madeira":["CD Nacional Madeira","Cd Nacional Madeira","Nacional"],
...
"Groznyj": ["Groznyj","Achmat Grozny","RFK Terek Grozny","Grozny"],
...
"St Mirren FC":["St Mirren FC","St. Mirren"],
...
"Bangor": ["Bangor"],
"Prestatyn": ["Prestatyn"],
"Barry": ["Barry","Barry Town"],
"Llansantffr.": ["Llansantffr."],
"Cefn Druids": ["Cefn Druids"],
"Aberystwyth": ["Aberystwyth"],
"Bala": ["Bala"],
"Cardiff MU": ["Cardiff MU","Cardiff Met Uni.","Cardiff Met"],
...
"Hellas Verona": ["Hellas Verona","H. Verona","Verona"],
...
"Reading": ["Reading"],
"Brentford": ["Brentford"],
"Wolverh.": ["Wolverh.","Wolverhampton","Wolverhampton Wanderers"],
"Burton": ["Burton","Burton Albion"],
"Sheff.Wed.": ["Sheff.Wed.","Sheffield Wed."],
"Cardiff": ["Cardiff","Cardiff City FC"],
"Q.P.R.": ["Q.P.R.","QPR"],
"Ipswich": ["Ipswich"],
...
"Nimes": ["Nimes","Nimes Olympique","Olympique Nimes"],
"Le Havre": ["Le Havre"],
"Paris FC": ["Paris FC"],
"Auxerre": ["Auxerre"],
"Quevilly": ["Quevilly"],
...
"Valenciennes": ["Valenciennes","Valenciennes","Valenciennes FC","Valenciennes CF"],
"Niort": ["Niort"],
