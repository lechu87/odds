...
events_mapping_sts = defaultdict(str)
events_mapping_sts = {
    "mecz": {"name": "game"},
    "mecz  (w Niecieczy)": {"name": "game"},
    "zakład bez remisu (remis=zwrot)": {"name": "dnb"},
...
"USA":["USA"],"Kostaryka":["Kostaryka"],"Trinidad i Tobago":["Trinidad i Tobago"], "Honduras":['Honduras'],"Meksyk":['Meksyk'],"Panama":['Panama'],
         ...
         "Las Palmas": ["Las Palmas","Las Palmas UD","UD Las Palmas"],"Atl. Madryt": ["Atl. Madryt","Atletico Madryt","Atl.Madryt"],"Eibar": ["Eibar","SD Eibar"],"Bilbao": ["Bilbao","Athletic Bilbao"],
...
"BATE Borisov": ["BATE Borisov","BATE","B.Borisov","BATE Borysów","Bate Borisov"],
...
"Atl.Mineiro MG": ["Atl.Mineiro MG","Atl. Mineiro","Atletico MG","America Mineiro MG"],
...
"Etar V.Tarnovo": ["Etar V.Tarnovo","Etar 1924 Veliko Tarnovo","Etar","Etar 1924"],
"Bot.Plovdiv": ["Bot.Plovdiv","Botev Płowdiw","Botev Plovdiv"],
"Lok.Plovdiv": ["Lok.Plovdiv","Lokomotiv Płowdiw","Lok. Plowdiv"],
"Dunav Ruse": ["Dunav Ruse","PFC Dunav Ruse","FK Dunav Ruse"],
...
"Botev Vratsa":["Botev Vratsa","OFC Botev Vratsa"],
...
"Dynamo Z.": ["Dynamo Z.","Din. Zagrzeb","NK Dinamo Zagrzeb","Dinamo Zagrzeb"],
...
"Slavia": ["Slavia","SK Slavia Praga","Slavia Praga"],
...
"Schalke": ["Schalke","FC Schalke 04","Schalke 04"],
...
"Orenburg":["Orenburg"],
"Kr. Sovetov":["Sovetov"],
"Lok.Moskwa": ["Lok.Moskwa","Lok. Moskwa","Lokomotiw M.","FC Lokomotiw Moskwa","Lokom. Moskwa","Lokomotiv Moskwa"],
...
"St.Johnstone": ["St.Johnstone","St. Johnstone","St. Johnstone FC","FC St Johnstone","St Johnstone"],
"Motherwell": ["Motherwell","FC Motherwell","Motherwell FC"],
"Hearts": ["Hearts","Hearts of Midlothian FC","Heart of Midlothian"],
"Kilmarnock": ["Kilmarnock","FC Kilmarnock","Kilmarnock FC"],
"Hamilton": ["Hamilton","Hamilton Academical FC","Hamilton Academicals"],
...
"Genoa": ["Genoa","FC Genua","Fc Genoa","Genoa CFC","Genua"],
...
"Sheff.Wed.": ["Sheff.Wed.","Sheffield Wed.","Sheffield Wednesday FC","Sheffield Wed"],
"Cardiff": ["Cardiff","Cardiff City FC","Cardiff City"],
...
"Sheff.Utd.": ["Sheff.Utd.","Sheffield Utd","Sheffield United"],
