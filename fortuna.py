...
class football_event:
    ...
    def prepare_dict_to_sql(self):
        ...
        #self.dict_sql['fortuna_1_st_goal_1'] = self.odds['1st_goal'][sehome]
        #self.dict_sql['fortuna_1_st_goal_2'] = self.odds['1st_goal'][away]
        #self.dict_sql['fortuna_1_st_goal_0'] = self.odds['1st_goal']['nikt']
