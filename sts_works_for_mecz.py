...
class one_event:
    __events_mapping={
        ...
        "liczba goli 2.5/wynik meczu": {"name": "o2.5"},
    ...
    def get_odds(self,data):
        self.odds = {}
        soup = BeautifulSoup(data, "html.parser")
        games = soup.find('table', {'class': 'col3'})
        #print games
...
data=file('www.sts.pl.htm','r').read()
meczyk=one_event()
